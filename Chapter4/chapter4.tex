...
\label{section_genes}
Integration and model training with \textit{CellTypist} allows us to have a global perspective of the influence of gene expression patterns in defining cell type and tissue identity.
...
\subsection{CellTypist as a functional reference for annotation}
\label{section_test}

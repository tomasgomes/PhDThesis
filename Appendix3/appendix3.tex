...
\begin{figure}[ht!] 
\centering    
\includegraphics[scale=1.25]{Appendix3/Figs/tissue_cluster_dataset_numbers_HumanAtlas.png} % change word in curlies to change figure
...
\begin{figure}[ht!] 
\centering
\includegraphics[scale=0.78]{Appendix3/Figs/appB_clmGSEA.png} % change word in curlies to change figure
